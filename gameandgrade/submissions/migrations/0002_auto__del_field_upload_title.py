...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Upload.title'
        db.delete_column(u'submissions_upload', 'title')


    def backwards(self, orm):
        # Adding field 'Upload.title'
        db.add_column(u'submissions_upload', 'title',
                      self.gf('django.db.models.fields.CharField')(default='filename', max_length=50),
                      keep_default=False)
