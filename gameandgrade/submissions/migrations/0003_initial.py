...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'submissions_upload', (
            ...
            ('title', self.gf('django.db.models.fields.CharField')(default='File Name', max_length=50)),
    ...
    models = {
        ...
        u'submissions.upload': {
            ...
            'task': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['submissions.Task']"}),
            'title': ('django.db.models.fields.CharField', [], {'default': "'File Name'", 'max_length': '50'}),
